...
Build https://github.com/clasp-developers/externals-clasp first and then ```cp clasp/wscript.config.template clasp/wscript.config``` and edit LLVM_CONFIG_BINARY = '/path/to/externals-clasp/llvm-config'
