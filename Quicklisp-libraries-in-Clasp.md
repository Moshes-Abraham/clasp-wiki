...
| ----------------- | ------- | ---------------- | ---------------- |--------------- |
|(ql:quickload "alexandria" :verbose t)|Yes|(ql:quickload "alexandria-tests" :verbose t) (alexandria-tests::run-tests :compiled nil) (alexandria-tests::run-tests :compiled t)| 226 tests 1 crash compiled|circular-tree-p.2 crashes to the os| 
