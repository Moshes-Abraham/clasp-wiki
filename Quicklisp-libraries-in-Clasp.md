...
|(ql:quickload "postmodern" :verbose t)|Changes needed|||in postmodern.asd add #clasp to the eval-when. Probaby error in postmodern to no longer work single threaded |
